...
Include the following header for authenticated access:

- `X-Karma-Admin-Auth`: `CoffeeCodesMelloBxAparnaEewqjbdkwqbkdjoehui3r7328grehjvdjvchjiuiudhsjkhkjsadab`

### Request Body

The request body should be sent as JSON. Below is the structure and an example of the request body:
...
Ensure the content type of the request is set to `application/json`. This API does not require any form of user authentication, but it does require the `X-Karma-Admin-Auth` header for administrative privileges.
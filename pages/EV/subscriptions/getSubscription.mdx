---
title: "getSubscription API Documentation"
---
...
- Make sure to replace the placeholders with your actual token and appropriate values as required.
- Ensure the request is authenticated properly before making a call to the endpoint.
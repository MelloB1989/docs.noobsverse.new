...
```
http://localhost:3000/v1/stations/create
```
...
The request body should be in JSON format. Below is an example:
...
Make sure to replace the example values with actual data as needed.